// cc_v30_kernel_test.js
// Comprehensive kernel validation — scorer + math + gates
// CSS Labs | Seal: 2026-06-19_14:58_Tulsa_OK
...
console.log('=== CC v3.0 Kernel Test Battery ===\n');
...
assert('D2 5 chars', CC.D2('abcde'), 0.0001);
...
assert('D6 embedded word', CC.D6('The killing field'), 0.0001);
...
assert('mu one low', CC.mu({D1:0.0001,D2:0.9997,D3:0.9997,D4:0.9997,D5:0.9997,D6:0.9997,D7:0.9997,D8:0.9997}), 0.5623, 0.01);
...
console.log('\nEvaluate Pipeline...');
const e1 = CC.evaluate('Hello world this is a test', {nodeCount: 0});
...
// --- Tesseract Vertex ---
console.log('\nTesseract Vertex...');
assert('Vertex PPPP', CC.assignTesseractVertex({signal:1,cognitive:0,energy:1,temporal:0,spatial:1,ethical:0,declarative:1,novelty:0}), 'PPPP');
assert('Vertex NNNN', CC.assignTesseractVertex({signal:0,cognitive:1,energy:0,temporal:1,spatial:0,ethical:1,declarative:0,novelty:1}), 'NNNN');
assert('Vertex PNPN', CC.assignTesseractVertex({signal:1,cognitive:0,energy:0,temporal:1,spatial:1,ethical:0,declarative:0,novelty:1}), 'PNPN');
...
console.log(`\nSeal: 2026-06-19_14:58_Tulsa_OK | Commit: 29cd165`);
